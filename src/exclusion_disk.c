...
void conrec (double **, int, int, int, int, double _Complex *, int, double *, void (*) (double, double, double, double, double));
...
int main ( int argc, char **argv ) 
{
  ...
  double r;            // The radious of the exclusion disks
  double e=0.1;
  double *s, *superb, *plot;
  double **data;
...
void drawline (BITMAP4 *image, double x1, double y1, double x2, double y2, double z)
{
    ...
    Draw_Line(image, SCALE * NGRID, SCALE * NGRID, (int)x1, (int)y1, (int)x2, (int)y2, BLACK_COLOR);
    vectorsdrawn++;
}
...
*/
void conrec (double **d, int ilb, int iub, int jlb, int jub, double _Complex * zcomplex, int nc, double *z, void (*ConrecLine) (double, double, double, double, double))
{
